...
const double rate1 = Rate1/4 ; // Failure rate of one modular of a specific partition (s = 1)
const double rate2 = Rate2/4;  // Failure rate of one modular of a specific partition (s = 2)
const double rate3 = Rate3/4;  // Failure rate of one modular of a specific partition (s = 3)
...
formula up = ((n2 != 6 & n1!= 3 & n0!= 1)& (p1 = 3|p1 = 2)&(p2 = 3|p2 = 2) & (p3 = 3|p3 = 2)&(p4 = 3|p4 = 2));
// The system temporarily fails and can still be reset through the scrubbing strategy
formula repair_down = (n2!= 6 & n1!= 3 & n0!= 1)& ((p1 = 1)|(p2 = 1)|(p3 = 1)|(p4 = 1));
// Due to the occurrence of run shock or extreme shock, the system permanently fails
formula down = (n2 = 6|n1 = 3|n0 = 1) & (p1 = 0) & (p2 = 0)&(p3 = 0)&(p4 = 0);

label "down" = (n2 = 6|n1 = 3|n0 = 1) & (p1 = 0) & (p2 = 0)&(p3 = 0)&(p4 = 0); 
label "repair_down" = (n2!= 6 & n1!= 3 & n0!= 1)& ((p1 = 1)|(p2 = 1)|(p3 = 1)|(p4 = 1));
label "up" =((n2 != 6 & n1!= 3 & n0!= 1)& (p1 = 3|p1 = 2)&(p2 = 3|p2 = 2) & (p3 = 3|p3 = 2)&(p4 = 3|p4 = 2));
